...
<div id="normal-sortables" class="meta-box-sortables">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <table cellspacing="10"> 
   <tr>
    <th align="left">ID</th><th align="left">Poll Name</th><th align="left">&nbsp; &nbsp; Options</th><th align="left">Shortcode for Pages and Posts</th>
   </tr> 
<?php  
...
?>
   <tr> 
    ...
    <td nowrap>&nbsp; &nbsp; 
                             <input type="button" name="calupdate_<?php echo $item->id; ?>" value="Rename" onclick="cp_updateItem(<?php echo $item->id; ?>);" /> &nbsp; 
                             <input type="button" name="calmanage_<?php echo $item->id; ?>" style="font-weight:bold" value="Settings" onclick="cp_manageSettings(<?php echo $item->id; ?>);" /> &nbsp;                              
    ...
    <td style="font-weight:bold;color: #006600;font-size:125%" nowrap>[<?php echo $this->shorttag; ?> id="<?php echo $item->id; ?>"]</td>          
   </tr>
<?php  
   } 
?>   
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     ...
     <table class="form-table">    
        ...
        <td><textarea type="text" name="CP_POLLS_rep_message" rows="3" cols="80"><?php echo esc_textarea(get_option('CP_POLLS_rep_message', 'Attached you will find the data from the form submissions.')); ?></textarea></td>
        </tr>        
        <tr valign="top">
        <th scope="row"></th>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside"> 
      <p>Use this area to add custom CSS styles or custom scripts. These styles will be keep safe even after updating the plugin.</p>
