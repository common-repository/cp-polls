...
<?php if ($this->get_option('cv_enable_captcha', CP_POLLS_DEFAULT_cv_enable_captcha) != 'false') { ?>
  <?php esc_html_e("Please enter the security code","cppolls"); ?>:<br />
  ...
  <br /><?php esc_html_e("Security Code (lowercase letters)","cppolls"); ?>:<br />
...
<div id="cp_subbtn<?php echo '_'.$this->print_counter; ?>" class="cp_subbtn"><?php esc_html_e($button_label,"cppolls"); ?></div>
